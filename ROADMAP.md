...
| Early Numeracy | Foundations | **LIVE — Phase 2 FROZEN + Phases 2.5, 3 & 4 shipped** — https://early-numeracy.pages.dev/ . Number-sense, ages 3–5. 🔒 [`brain/apps/early-numeracy-roadmap.md`](./brain/apps/early-numeracy-roadmap.md) (Phases 1–10). **Phase 2 FROZEN** (`fa777a6`): six no-fail modules + progress store + growing Math Village. **Phase 2.5** (`22b5a0b`): 🌞 Today + 🔢 Number Match + 🔍 Number Hunt. **Phase 3** (`dacd6a6`): 🌍 Numbers Everywhere (7 scenes). **Phase 4** (`7da1f98`): ➕ Addition Adventure (5 themes). **Phase 5** (`420280d`): ➖ Taking Away (5 themes, visual subtraction). Home = Play & Learn · Adding & Taking Away · Practice · Explore. **Play-test pending → Freeze 2.5–5; Phase 6 (Shapes World) next.** |
