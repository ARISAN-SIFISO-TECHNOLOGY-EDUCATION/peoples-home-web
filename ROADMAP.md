...
| Early Numeracy | Foundations | **LIVE — Phase 2 shipped** — https://early-numeracy.pages.dev/ . Number-sense, ages 3–5. 🔒 [`brain/apps/early-numeracy-roadmap.md`](./brain/apps/early-numeracy-roadmap.md) (Phases 1–10). **Phase 2 — Number Discovery BUILT & LIVE (2026-07-04, `fa777a6`):** six real no-fail modules (Counting Garden · Which is More · Number Shapes · Pattern Maker · Make Five · Make Ten), progress store + growing Math Village reward. **Awaiting real-child play-test → then Freeze; Phase 2.5 (Numeracy Confidence) next.** |
