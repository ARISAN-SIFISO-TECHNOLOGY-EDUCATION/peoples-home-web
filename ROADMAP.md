...
| Space Explorer | Curiosity | **LIVE (installable offline PWA)** — https://ikhaya-space-explorer.pages.dev/ (2026-07-03). Built in Gemini AI Studio; brought in-house (AI dropped, offline PWA, CSP, real icons, storage bug fixes, new README) + deployed + linked on the site. Solar-system discovery, ages 3–17. Subdomain `ikhaya-space-explorer` (bare one was taken). **Next: real-child play-test.** See `brain/apps/space-explorer.md`. |
| African Discoveries | Curiosity | **LIVE (installable offline PWA)** — https://african-discoveries.pages.dev/ (2026-07-06). The **4th Curiosity app**. Built by the founder in Gemini via a Manus/Builder "forge" scaffold; brought fully in-house (scaffold stripped: Google-Maps/forge proxy, Manus OAuth + debug collector + umami + vite plugins removed, express server dropped; 6 images recovered from the published Manus app; Fredoka self-hosted; strict CSP; real offline PWA — SW precache 28 entries + true-PNG icons) + deployed (git-connected Cloudflare Pages) + linked on the site. Africa's heroes · wildlife · innovations · timeline, ages 3–17. Repo PRIVATE `african-discoveries` (`c7affc3`). **Next: real-child play-test.** See `brain/apps/african-discoveries.md`. |
...
| Early Numeracy | Foundations | **⏸ MARKED NOT-LIVE on the TPH site 2026-07-06** — founder not satisfied with the UI; card **stays listed** in the Foundations pillar but flipped `status:'soon'` (renders "Coming soon", not clickable) + Foundations "· in progress" badge restored. The app repo, its deploy (https://early-numeracy.pages.dev/), and all Brain knowledge remain intact; re-enable = flip `status` back to `'live'`. Awaiting UI-redo instructions. — **Phases 2–9 shipped (no phase Frozen; Phase 2 unfrozen 2026-07-04)** — https://early-numeracy.pages.dev/ . Number-sense, ages 3–5. 🔒 [`brain/apps/early-numeracy-roadmap.md`](./brain/apps/early-numeracy-roadmap.md) (Phases 1–10). **Phase 2** (`fa777a6`, was Frozen → **unfrozen** by founder): six no-fail modules + progress store + growing Math Village. **Phase 2.5** (`22b5a0b`): 🌞 Today + 🔢 Number Match + 🔍 Number Hunt. **Phase 3** (`dacd6a6`): 🌍 Numbers Everywhere (7 scenes). **Phase 4** (`7da1f98`): ➕ Addition Adventure (5 themes). **Phase 5** (`420280d`): ➖ Taking Away (5 themes). **Phase 6** (`ac1634d`): 🔷 Shapes World (5 activities). **Phase 7** (`76c1118`): 📏 Measuring World (3 activities — compare · arrange · measure). **Phase 8** (`99afc3f`): 🕐 Time & Day (3 activities — time of day · sequence · clock). **Phase 9** (`c6f4c6e`): 💰 Money Shop (3 activities — match · shop · sort; SA coins & notes). **Phase 10** (`99066d8`, FINAL phase): 📊 Sort & Graph (3 activities — sort · graph · group; charts + classification). Home = Play & Learn · Adding & Taking Away · Shapes · Measuring · Time & Day · Money & Shop · Sort & Graph · Practice · Explore. **🎉 All educational phases 2–10 done & live.** 🌈 **Experience layer — [`Number Kingdom`](./brain/apps/number-kingdom-roadmap.md)** (2026-07-04): product stays *Early Numeracy*, child enters the world *Number Kingdom*; 16 modules stay intact, a world-map shell is built over them (NK-0…NK-6, Blueprint→Freeze→Build). **Roadmap ✅ FROZEN · NK-0 ✅ FROZEN · NK-1 ✅ FROZEN (`f75d69a`; Welcome Moment → DNA Principle 18) · NK-2 Living Kingdom ✅ FROZEN (`5ee188b`; world grows with play + day/night & weather) · NK-3 Math Adventure Journal ✅ FROZEN (`3ada8bc`; derived journey memory — discoveries · places · favourite game · 12 stamps) · NK-4 Companion ✅ BUILT & LIVE (`e22602b`) — 🐿️ Pip the Kingdom Guide walks the map with scripted invitations (no runtime AI, guide-layer only) — awaiting founder Freeze; NK-5 (Regional Identity — per-module skins) next.** |
| Early Literacy | Foundations | **LIVE (installable offline PWA)** — https://early-literacy.pages.dev/ . Emergent literacy 3–7 ("Village"). Built externally (Gemini); Phases 1–4 (Listening → Sound → Letters → First Words) + navigation framework. **AI dropped for #FreeForever; deployed + offline PWA + Phase-1 audit fixes; repo moved to org — 2026-07-02.** Consumes engines via Event Bus; adds WordEngine + ReadingJourneyEngine. ⚠️ remaster backlog Phases 2–5 + "TPH Core" naming — see [`brain/apps/early-literacy.md`](./brain/apps/early-literacy.md). |
