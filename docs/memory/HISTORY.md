...
- **Standing action (OUTSTANDING, high priority):** keep an **encrypted off-machine backup** of
  ...
  but it must exist in more than one place. See root [`DECISIONS.md`](../../DECISIONS.md) → "Critical-information risk."
...
*Full reasoning:* [`canon/04-delivery-model.md`](./canon/04-delivery-model.md) and
[`DECISIONS.md`](./DECISIONS.md).

### Capability architecture (2026-06-21)
~40 imagined apps → a capability *system* (≈10 deep apps + iKhaya + TPH Core).
*Full reasoning:* [`canon/01-capability-architecture.md`](./canon/01-capability-architecture.md).
