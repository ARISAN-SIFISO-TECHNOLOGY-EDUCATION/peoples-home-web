...
>
> This is the *story*; for the reasoning behind each turn see [`DECISIONS.md`](./DECISIONS.md),
> and for incidents see [`HISTORY.md`](./HISTORY.md).
...
- **~06-09 — Keystore rotation** (Math Adventure). Upload key rotated to `upload-new.jks`;
  `keystore.properties` switched; v2.0/code5 AAB signed with the new key. (See [`HISTORY.md`](./HISTORY.md).)
...
- **06-12 — THE WEB-FIRST PIVOT.** Stop prioritising Google Play (slow review, morale cost).
  ...
  site. This is the hinge of the whole delivery model. (See [`canon/04-delivery-model.md`](./canon/04-delivery-model.md).)
...
- **06-21 — THE CAPABILITY ARCHITECTURE (v2 BLUEPRINT).** The biggest conceptual reframe:
  ...
  formalised. (See [`canon/01`](./canon/01-capability-architecture.md), [`canon/02`](./canon/02-world-a-world-b-dna.md).)
