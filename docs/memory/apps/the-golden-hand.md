...
- **The rename (2026-06-23): "Learn Python" → "The Golden Hand."** Recognising it was never a
  ...
  avoid breaking Cloudflare/the live link — display name only. (See [`../HISTORY.md`](../HISTORY.md).)
...
- **CRA build quirks:** must build with **`CI=false`**; output dir is **`build`** not `dist`;
  **lockfile gitignored**. (See [`../canon/04-delivery-model.md`](../canon/04-delivery-model.md).)
...
offline app World-A-pure. See open decisions in [`../DECISIONS.md`](../DECISIONS.md).

## Related
- [`tech-makers.md`](./tech-makers.md) (the separation decision) ·
  [`micro-founders.md`](./micro-founders.md) (shared "1M Startups" vision) ·
  [`../canon/02-world-a-world-b-dna.md`](../canon/02-world-a-world-b-dna.md) (why server-backed is a problem here).
