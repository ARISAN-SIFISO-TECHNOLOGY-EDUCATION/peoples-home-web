...
|---|---|
| An app ships, or a major feature lands | the app's `apps/*.md` (state + iteration note) · [`CURRENT_STATE.md`](./CURRENT_STATE.md) · [`TIMELINE.md`](./PROJECT_TIMELINE.md) |
| A structural / architectural decision is made | [`DECISIONS.md`](./decisions/DECISIONS.md) (append) · the relevant `canon/*.md` if it changes a principle |
| A rename, pivot, or retired idea | [`HISTORY.md`](./history/HISTORY.md) + the affected app/platform memory |
...
| An incident (keystore, rejection, outage) | [`HISTORY.md`](./history/HISTORY.md) |
...
be able to clone it, read [`README.md`](./README.md) → [`AI_READING_ORDER.md`](./AI_ONBOARDING.md),
