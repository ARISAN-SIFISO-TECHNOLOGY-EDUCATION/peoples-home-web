...
> Conceptual context: [`../canon/05-tph-core-and-passport.md`](../architecture/03-tph-core-and-passport.md).
...
- [`tph-core.md`](./tph-core.md) (where progress lives) ·
  ...
  [`../canon/05-tph-core-and-passport.md`](../architecture/03-tph-core-and-passport.md).
